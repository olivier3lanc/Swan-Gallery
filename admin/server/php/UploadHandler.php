...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        global $tpl_medium_width;
        global $tpl_medium_height;
        global $tpl_thumb_crop;
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => '../../../'.$gallery_folder.'/',
            'upload_url' => '../'.$gallery_folder.'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            */
            ...
            'image_versions' => array(
                ...
                'medium' => array(
                    'max_width' => $tpl_medium_width,
                    'max_height' => $tpl_medium_height
                ),
                ...
                'thumbnail' => array(
                    ...
                    'upload_dir' => '../../../'.$gallery_folder.'/'.$ph_thumbs_dir.'/',
                    'upload_url' => '../'.$gallery_folder.'/'.$ph_thumbs_dir.'/',
                    // Uncomment the following to force the max
                    // dimensions and e.g. create square thumbnails:
                    'crop' => $tpl_thumb_crop,
                    'max_width' => $tpl_thumb_width,
                    'max_height' => $tpl_thumb_height
                )
            )
        );
        if ($options) {
    ...
    protected function trim_file_name($file_path, $name, $size, $type, $error,
        ...
        //Replace unwanted characters from filename before extension and force lowercase to extension
        $safe_name = explode('.', $name);        
        $name = flatten($safe_name[0]).'.'.strtolower($safe_name[1]);
